...
const Honoring = () => {
  return (
    <section className="section-grid py-3xl bg-white">
      <div className="ml-[6vh] col-span-full md:col-span-8 relative h-[40vh] md:h-[75vh]">
        <ImageWithOverlay
      ...
      <div className="col-span-8 md:col-start-9 max-md:px-[6vw] md:col-span-5 flex items-end mt-lg md:mt-0">
